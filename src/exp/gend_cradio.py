...
experiments = {
    ...
    "test-cradio-dfd-sam-labelsmooth-all": [
        Config(
            ...
            mini_batch_size=128,
            devices=[0],
            checkpoint="runs/sam/cradio-v2-dfd-sam-labelsmooth/checkpoints/own-cradio-best_mAP.ckpt",
            from_exp="cradio-v2-dfd-sam-labelsmooth",
            wandb=True,
            resume=True,
            wandb_id="orno4nks",
        )
    ...
    "test-cradio-dfd-sam-labelsmooth-ntire": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=NTIRE.val,
    ...
    "test-cradio-dfd-sam-labelsmooth-uadfv": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-dfd": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=DFD.test,
    ...
    "test-cradio-dfd-sam-labelsmooth-dfdc": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=DFDC.test,
    ...
    "test-cradio-dfd-sam-labelsmooth-fsh": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=FSh.test,
    ...
    "test-cradio-dfd-sam-labelsmooth-cdfv2": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-ffiw": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=FFIW.test,
    ...
    "test-cradio-dfd-sam-labelsmooth-kodf-normal": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=KoDF.test,
    ...
    "test-cradio-dfd-sam-labelsmooth-kodf-adv": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-kodf-all": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-fakeavceleb": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-dfdm": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=DFDM.test,
    ...
    "test-cradio-dfd-sam-labelsmooth-polyglotfake": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-idforge": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-deepspeakv1": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-deepspeakv2": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-cdfv3": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
    ...
    "test-cradio-dfd-sam-labelsmooth-ff": [
        Config(
            run_dir="runs/com-test/cradio-ff-no-f2f",
            backbone=C.Backbone.C_RADIOV4_SO400M,
            tst_files=CDFv3.test,
